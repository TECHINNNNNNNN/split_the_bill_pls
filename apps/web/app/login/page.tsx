    ...
    <div className="relative flex min-h-svh flex-col items-center justify-center overflow-hidden px-6">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-2.5">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="flex h-11 w-11 items-center justify-center rounded-full bg-[#FC6D26] text-white transition-all hover:bg-[#e45f1e] hover:shadow-sm active:scale-95 disabled:opacity-40"
              title="GitLab"
            >
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M22.65 14.39L12 22.13.35 14.39c-.22-.17-.31-.47-.2-.73L1.9 9.38l3.47 10.75h13.26L22.1 9.38l1.75 4.28c.11.26.02.56-.2.73zM12 22.13l6.3-2H5.7l6.3 2zM7.37 9.38h9.26L12 .77 7.37 9.38zm-5.47 0h3.47L1.9 9.38zm16.73 0h3.47L18.63 9.38zM1.9 9.38L5.37.63h-3.8l.33.82L1.9 9.38zm20.2 0l.33-7.93-.33-.82h-3.8l3.47 8.75z" /></svg>
            </button>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => {
              toast("เค้าบอกต้องมี 250k users ถึงจะใช้ได้ 😭", {
                description: "Spotify หวงแหนมาก ไม่ยอมให้ใช้ฟรี 🎵",
              });
            }}
            className="flex items-center gap-1.5 rounded-full bg-[#1DB954] px-4 py-1.5 text-[11px] font-medium text-white transition-all hover:bg-[#1aa34a] active:scale-[0.97]"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-full bg-black px-4 py-1.5 text-[11px] font-medium text-white transition-all hover:bg-gray-800 active:scale-[0.97]"
          >
