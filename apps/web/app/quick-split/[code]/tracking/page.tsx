    ...
    <div className="flex min-h-svh flex-col px-6 py-6 md:mx-auto md:max-w-lg md:py-12">
      ...
      {isHost && liff.isSupported && (
        <button
          ...
          className="mt-3 flex items-center gap-1.5 self-start rounded-full bg-[#06C755] px-4 py-1.5 text-sm font-medium text-white transition-opacity hover:opacity-90 active:opacity-80 disabled:opacity-40"
        >
