            ...
            <div className="flex items-center gap-2">
              ...
              {liff.isSupported && (
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-full bg-[#5a9e6e] px-5 py-2.5 text-sm font-medium text-cream-light shadow-sm transition-all hover:bg-[#4e8c60] active:scale-[0.97] disabled:opacity-40 md:px-6 md:text-base"
                >
